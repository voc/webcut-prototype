jQuery.fn.videoControls = function() {
  ...
  create = function(src) {
    ...
    instance.wrapper.append('<table><tr>'+
      '<td><a class="button rw" href="#">Rew</a></td>'+
      '<td><a class="button stepRw" href="#">Step Back</a></td>'+
      '<td><a class="button pp play" href="#">Play</a></td>'+
      '<td><a class="button stepFf" href="#">Step Foward</a></td>'+
      '<td><a class="button ff" href="#">FFward</a></td>'+
      '</tr>'+
      '<tr><td colspan=5>Time: <span class="timer"/></td>'+
      //'<tr><td colspan=5>Timecode in: <input type="text" class="timerInput" /></td>'+
      '</tr></table>');
  ...
  var activateKeyControl = function() {
    $(document).keydown(function(e) {
      ...
      if (e.keyCode == 73) { // i
        //cut in
        instance.player.cutin=Math.floor(instance.player.currentTime*instance.frame_rate);;
      }
      if (e.keyCode == 79) { // o
        //cut out
        instance.player.cutout=Math.floor(instance.player.currentTime*instance.frame_rate);
        if (instance.player.cutin>instance.player.cutout)
          instance.player.cutin=instance.player.cutout;
      }
      // Arrow Keys
      if (e.keyCode == 37) {
  ...
  var formatTimer = function(position) {
    ...
    var ft_gframes = Math.floor(position*instance.frame_rate);
    ft_hours += '';
